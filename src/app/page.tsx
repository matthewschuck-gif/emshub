...
const DEFAULT_TOOLS: Tool[] = [
  ...
  // New tools
  { id: "traitdough",     name: "Trait Dough",            abbr: "TD",  url: "https://matthewschuck-gif.github.io/trait-dough/",                                                                           desc: "Log LRG traits → live squad points in CoC",        color: "#16a34a" },
  ...
  // MLC Handbooks — double-click URL on any card to update the Google Doc link
  { id: "mlc-handbook",   name: "MLC Handbook",           abbr: "MLC", url: "https://docs.google.com/document/d/1IiUT0W1rpREqMdoWrHuVbziU8R9pqXOthQo3_1lIiqk/edit",                                   desc: "Mountaineer Leadership Corps — all tracks overview", color: "#0891b2" },
  { id: "hb-generals",    name: "Squad Generals Handbook",abbr: "GEN", url: "#",                                                                                                                          desc: "Track 1 — Generals & Captains, CoC year-round leadership", color: "#ffe100" },
  { id: "hb-ambassadors", name: "Ambassador Handbook",    abbr: "AMB", url: "#",                                                                                                                          desc: "Track 2 — New student belonging & first-month experience", color: "#06b6d4" },
  { id: "hb-delegates",   name: "Delegates Handbook",     abbr: "DEL", url: "#",                                                                                                                          desc: "Track 3 — Student council voice & service projects", color: "#10b981" },
  { id: "hb-vanguard",    name: "Vanguard Handbook",      abbr: "VAN", url: "#",                                                                                                                          desc: "Trailback Panel — restorative discipline & peer support", color: "#f59e0b" },
  // Squad docs
